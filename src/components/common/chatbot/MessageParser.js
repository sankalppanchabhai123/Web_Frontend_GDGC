...
class MessageParser {
  ...
  parse(message) {
    ...
    else if ((message1.includes('gdgc')) && message1.includes('why')) {
      this.ActionProvider.whygdgc();
    }

    else if ((message1.includes('gdgc'))) {
    ...
    else if ((message1.includes('faculty') || message1.includes('teacher') || message1.includes('professor')) && message1.includes('join') && (message1.includes('gdgc') || message1.includes('club'))) {
      this.ActionProvider.join_faculty();
    }

    else if ((message1.includes('benefits') || message1.includes('advantages') || message1.includes('why')) && message1.includes('gdgc') && message1.includes('lead')) {
