...
// import group from './Group_268.png'
...
const hellomsg = ["What is GDGC", "How to join?", "Why to join?", "what is a chapter"]


const config = {
  initialMessages: [createChatBotMessage("Hi there! Welcome to the GDGC Family!!")],
  customComponents: {
